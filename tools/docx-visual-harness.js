...
//
// 用法：
//   node tools/docx-visual-harness.js <docx 檔或目錄...> --out <輸出目錄> [--force]
//   例：node tools/docx-visual-harness.js "docs/excluded/test docx/2026-09-03 output/pseudo" \
...
if (!OUT_DIR || inputs.length === 0) {
  console.error('用法：node tools/docx-visual-harness.js <docx 檔或目錄...> --out <輸出目錄>');
  process.exit(1);
}
